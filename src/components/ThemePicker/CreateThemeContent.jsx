    ...
    <>
        ...
        <Container>
            ...
            <Section>
                ...
                <Preview style={{ borderRadius:"12px", backgroundColor: state.bgColor, color: state.txtColor, fontFamily: state.font}}>
                    <p>
                    ...
                    <button className="btn" style={{
                        margin:"auto",
                        borderRadius:"10px",
                        backgroundColor:state.btnBgColor, color:state.btnTxtColor, fontFamily: state.font}}>
                        I am a Chat Bubble
                    </button> {'  '}
